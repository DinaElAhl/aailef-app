...
export const AXES = [
  {
    ...
    guide:
      "قيّم صحة الإملاء ورسم الهمزات والتاء المربوطة/المفتوحة والألف المقصورة وعلامات الترقيم. 5 = خالٍ من الأخطاء، 1 = أخطاء إملائية متكررة تعيق القراءة.",
  },
  {
    id: "A2",
    ...
    guide:
      "قيّم قدرة النص على إزالة الغموض الناتج عن غياب التشكيل، وصحة أي تشكيل مستخدم. 5 = لا لبس في المعنى المقصود، 1 = غموض يُربك القارئ أو تشكيل خاطئ.",
  },
  {
    id: "A3",
    name: "الاتساق الصرفي",
    ...
    guide:
      "قيّم صحة الاشتقاق والأوزان الصرفية واتساق الجموع والمصادر. 5 = صرف سليم متسق، 1 = صيغ شاذة أو اشتقاقات خاطئة.",
  },
  {
    id: "A4",
    ...
    guide:
      "قيّم المطابقة في التذكير والتأنيث والعدد بين الفعل والفاعل والصفة والموصوف. 5 = مطابقة تامة، 1 = أخطاء مطابقة متكررة.",
  },
  {
    id: "A5",
    name: "سلامة التركيب",
    ...
    guide:
      "قيّم سلامة بناء الجملة وترتيب عناصرها وصحة الروابط، وخلوّها من التراكيب المترجمة حرفياً (calque). 5 = تركيب عربي سليم، 1 = جمل مفككة أو مترجمة حرفياً.",
  },
  {
    id: "A6",
    name: "وضوح المعنى",
    ...
    guide:
      "قيّم وضوح المعنى وخلوّه من التناقض الداخلي أو التعميم المُخل. 5 = معنى واضح متماسك، 1 = معنى غامض أو متناقض.",
  },
  {
    id: "A7",
    ...
    guide:
      "قيّم ملاءمة النص للسياق المطلوب (طبي/علمي مقابل اجتماعي/عام) ودقّة التمييز بينها. 5 = ملائم تماماً للسياق، 1 = خلط بين السياقات يُغيّر المعنى.",
  },
  {
    id: "A8",
    ...
    guide:
      "قيّم التزام النص بالسجل المطلوب (فصحى أكاديمية، فصحى مبسطة، عامية…) دون انزلاق غير مقصود بين المستويات. 5 = ثبات تام على السجل، 1 = تذبذب يُخالف المطلوب.",
  },
  {
    id: "A9",
    name: "دقة المصطلح",
    ...
    guide:
      "قيّم استخدام المصطلحات العربية المعتمدة (خصوصاً الطبية/العلمية) وتجنّب الترجمة الحرفية المُخِلّة. 5 = مصطلحات دقيقة معتمدة، 1 = مصطلحات خاطئة أو مترجمة حرفياً.",
  },
  {
    id: "A10",
    ...
    guide:
      "قيّم مدى تحقيق النص للهدف الوظيفي للمهمة المطلوبة (تلخيص/إجابة/ترجمة…) بصرف النظر عن اللغة وحدها. 5 = حقّق الهدف بالكامل، 1 = أخفق في المهمة.",
  },
];
